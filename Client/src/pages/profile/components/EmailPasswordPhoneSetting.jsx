...
const EmailPasswordPhoneSetting = () => {
        ...
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              ...
              <Button onClick={handleEmailUpdate} className="mt-4 p-2">
                Update Email
              </Button>
              ...
              <Button onClick={handlePasswordUpdate} className="mt-4 p-2">
                Update Password
              </Button>
              ...
              <Button onClick={handlePhoneNumberUpdate} className="mt-4 p-2 ">
                Update Phone Number
              </Button>
            </DialogDescription>
          </DialogHeader>
...
export default EmailPasswordPhoneSetting;
