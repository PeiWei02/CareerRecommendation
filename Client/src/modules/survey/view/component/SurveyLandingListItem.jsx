...
export const SurveyLandingListItem = (props) => {
  ...
  return (
    ...
    >
      <Card className="py-2 px-6 hover:bg-gray-800 transition duration-300 ease-in-out shadow-md hover:shadow-lg">
        <div className="h-full w-[50vw] grid grid-cols-12 gap-5 items-center">
